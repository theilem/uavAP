...
#ifndef UAVAP_CORE_FRAMES_INERTIALFRAME_H_
#define UAVAP_CORE_FRAMES_INERTIALFRAME_H_
#include <uavAP/Core/Frames/IFrame.h>

class InertialFrame: public IFrame
{
public:
...
#endif /* UAVAP_CORE_FRAMES_INERTIALFRAME_H_ */
