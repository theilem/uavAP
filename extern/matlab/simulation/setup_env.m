...
[Kcplist(:,:,1), kpp_min20] = generate_20(linp_min20, coefp_min20, Qc_20, Rc_20);
...
[A_20, b_20] = polyArrayToTensor(Rp0_20);
[A_min20, b_min20] = polyArrayToTensor(Rp0_min20);
