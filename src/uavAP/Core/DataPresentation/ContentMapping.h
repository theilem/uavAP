...
#define MAPPING(FUNC)		MAP(SENSOR_DATA, SensorData, FUNC) 												\
							...
							MAP(LINEAR_LOCAL_PLANNER_STATUS, LinearLocalPlannerStatus, FUNC)								\
							MAP(MANEUVER_LOCAL_PLANNER_STATUS, ManeuverLocalPlannerStatus, FUNC)								\
							...
							MAP(TUNE_LINEAR_LOCAL_PLANNER, LinearLocalPlannerParams, FUNC) 								\
							MAP(TUNE_MANEUVER_LOCAL_PLANNER, ManeuverLocalPlannerParams, FUNC) 								\
...
MATCH_TYPE_AND_ENUM(LinearLocalPlannerStatus, Content::LINEAR_LOCAL_PLANNER_STATUS);
MATCH_TYPE_AND_ENUM(ManeuverLocalPlannerStatus, Content::MANEUVER_LOCAL_PLANNER_STATUS);
...
MATCH_TYPE_AND_ENUM(LinearLocalPlannerParams, Content::TUNE_LINEAR_LOCAL_PLANNER);
MATCH_TYPE_AND_ENUM(ManeuverLocalPlannerParams, Content::TUNE_MANEUVER_LOCAL_PLANNER);
