...
#ifndef UAVAP_FLIGHTCONTROL_CONTROLLER_MANEUVERPIDCONTROLLER_MANEUVERPIDCONTROLLER_H_
#define UAVAP_FLIGHTCONTROL_CONTROLLER_MANEUVERPIDCONTROLLER_MANEUVERPIDCONTROLLER_H_
...
class ManeuverPIDController: public IController, public IAggregatableObject, public IRunnableObject
{
public:
...
private:
	...
	void
	onManeuverTarget(const OverrideTarget& manTarget);

	void
	onManeuverActivation(const OverrideActivation& manActivation);
	...
	OverrideTarget overrideTarget_;
	Subscription overrideTargetSubscription_;

	Subscription overrideActivationSubscription_;
...
#endif /* UAVAP_FLIGHTCONTROL_CONTROLLER_MANEUVERPIDCONTROLLER_MANEUVERPIDCONTROLLER_H_ */
