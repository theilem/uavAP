...
api_sense(const SensorDataEdu& data)
{
	...
	std::cout << "Accelera: " << data.acceleration[0] << ", " << data.acceleration[1] << ", " << data.acceleration[2] << std::endl;
	std::cout << "Attitude: " << data.attitude[0] << ", " << data.attitude[1] << ", " << data.attitude[2] << std::endl;
	std::cout << "AngularR: " << data.angularRate[0] << ", " << data.angularRate[1] << ", " << data.angularRate[2] << std::endl;
	std::cout << "====================================================" << std::endl;
