...
void
MicroSimulator::notifyAggregationOnUpdate(Aggregator&)
{
}
...
bool
MicroSimulator::waitFor(Duration duration, boost::condition_variable& interrupt, boost::unique_lock<boost::mutex>& lock)
{
	if (stopOnWait_)
	{
...
bool
MicroSimulator::waitUntil(TimePoint timePoint, boost::condition_variable& interrupt, boost::unique_lock<boost::mutex>& lock)
{
	if (stopOnWait_)
	{
