...
FloatingType
InertialFrame::toInertialFrameCourse(FloatingType chi) const
{
	return chi;
}
...
FloatingType
InertialFrame::fromFrameCourse(const IFrame &orig, FloatingType chi) const
{
	return orig.toInertialFrameCourse(chi);
}
