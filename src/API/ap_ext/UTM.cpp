...
{
	FloatingType alpha, beta, gamma, delta, epsilon, n;
	FloatingType result;
...
{
	FloatingType cmeridian;
	cmeridian = DegToRad(-183.0 + ((FloatingType) zone * 6.0));
...
{
	FloatingType y_, alpha_, beta_, gamma_, delta_, epsilon_, n;
	FloatingType result;
...
MapLatLonToXY(FloatingType phi, FloatingType lambda, FloatingType lambda0, FloatingType &x,
		FloatingType &y)
{
	FloatingType N, nu2, ep2, t, t2, l;
	FloatingType l3coef, l4coef, l5coef, l6coef, l7coef, l8coef;
	//FloatingType tmp; // Unused
...
MapXYToLatLon(FloatingType x, FloatingType y, FloatingType lambda0, FloatingType& phi,
		FloatingType& lambda)
{
	FloatingType phif, Nf, Nfpow, nuf2, ep2, tf, tf2, tf4, cf;
	FloatingType x1frac, x2frac, x3frac, x4frac, x5frac, x6frac, x7frac, x8frac;
	FloatingType x2poly, x3poly, x4poly, x5poly, x6poly, x7poly, x8poly;
